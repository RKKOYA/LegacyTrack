...
2. Extract the .zip file and you should be getting a folder.
3. 
4. Navigate to the resource packs folder in your minecraft directory (.minecraft/resourcepacks) and put the zip file there.
